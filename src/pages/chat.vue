  ...
  <div class="messenger-page" ref="pageRoot">
    ...
    <div class="chat-scroll" ref="chat">
      <template v-for="(m, idx) in normalizedMessages" :key="m._key">
        ...
        <div class="time-chip" v-if="shouldShowDate(idx)">
          {{ dateChipLabel(m) }}
        </div>
          ...
          >
            ...
            <div class="bubble-meta">
              ...
              <div v-if="m.direction === 'outgoing'" class="message-status">
                ...
                >
                  <v-icon size="12" color="rgba(255,255,255,0.6)"
                    >mdi-check</v-icon
                  >
                  <v-icon size="12" color="rgba(255,255,255,0.6)"
                    >mdi-check</v-icon
    ...
    <div class="composer my-6" ref="composer">
      ...
      <!-- Reply preview -->
        ...
        <!-- Tools -->
        <div class="tools">
          <v-icon class="tool" @click="toggleEmojiPicker" aria-label="Emoji"
            >mdi-emoticon-outline</v-icon
          >
          <v-icon class="tool" @click="triggerFileSelect" aria-label="Attach"
...
export default {
  ...
  methods: {
    ...
    getEmojiOptions() {
      ...
      if (this.emojiCategory === "recent" && this.recentEmojis.length)
