    ...
    <v-container fluid>
      ...
      <v-row class="mb-4">
        ...
        <v-col
          ...
          md="3"
        >
          <v-btn class="request-btn" @click="addInspection">
            Request Inspection
          </v-btn>
        </v-col>
      </v-row>
      ...
      <v-row>
        <v-col cols="12">
          ...
          >
            <template #item.inspectionRequired="{ item }">
              <v-chip
            ...
            <template #item.appointmentMade="{ item }">
              <v-chip
            ...
            <template #item.quotesNeeded="{ item }">
              <v-chip
            ...
            <template #item.document="{ item }">
              ...
              <div v-else class="d-flex align-center justify-center">
                <v-icon color="grey" icon="mdi-file-remove" size="small" />
              </div>
            </template>
