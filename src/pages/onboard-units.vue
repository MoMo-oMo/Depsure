  ...
  methods: {
    ...
    async findExistingMaintenance(item) {
      try {
        ...
        console.warn("findExistingMaintenance error", e);
        return null;
      }
    },
    async findExistingVacancy(item) {
      try {
        ...
        console.warn("findExistingVacancy error", e);
        return null;
      }
    },
    async findExistingFlagged(item) {
      try {
        ...
        console.warn("findExistingFlagged error", e);
        return null;
      }
    },
    async findExistingInspection(item) {
      try {
        ...
        console.warn("findExistingInspection error", e);
        return null;
      }
    },
