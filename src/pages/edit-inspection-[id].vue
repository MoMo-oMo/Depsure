<template>
  <div class="edit-inspection-page">
    <v-container fluid>
      ...
      <v-row class="mb-4">
        <v-col cols="12">
          <v-btn class="back-btn" @click="goBack">Back</v-btn>
        </v-col>
      </v-row>
          ...
          <div v-else class="form-card" elevation="0">
            <v-form ref="form" v-model="valid" lazy-validation>
              ...
              <v-card-actions class="pa-4">
                <v-spacer />
                <v-btn class="cancel-btn" color="grey" variant="outlined" @click="goBack">
                  Cancel
                </v-btn>
                <v-btn
                  class="save-btn"
  ...
  export default {
    ...
    mounted () {
      ...
      if (entryId) this.loadEntryData(entryId)
        ...
        this.error = 'Entry ID not found'; this.loading = false
      }
    },
    methods: {
      goBack () {
